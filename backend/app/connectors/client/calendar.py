...
class CalendarClient:
    ...
    def update_event(self, request: CalendarUpdateEventRequest) -> CalendarEvent:
        try:
            event = self.service.events().get(calendarId='primary', eventId=request.event_id).execute()
            ...
            if request.attendees:
                event['attendees'] = [{'email': attendee} for attendee in request.attendees]

            updated_event = self.service.events().update(calendarId='primary', eventId=request.event_id, body=event).execute()

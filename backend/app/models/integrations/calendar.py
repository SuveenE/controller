...
class CalendarUpdateEventRequest(BaseModel):
    ...
    start_time: Optional[str] = Field(description="Updated start time in ISO format, if any")
    end_time: Optional[str] = Field(description="Updated end time in ISO format, if any")
